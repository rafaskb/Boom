...
public class ReverbData {
    ...
    public float   gainLF;
    /**
     * Controls reverb decay time. (similiar to echo) Ranges from 0.1 (suitable for very small room) to 20.0 (large
     * room)
     * <p>
    ...
    /**
     * 3D vector that controls the spatial distribution of the cluster of early reflections. The direction of this
     * vector controls the global direction of the reflections, while its magnitude controls how focused the reflections
     * are towards this direction.
     * <p>
    ...
    /**
     * 3D vector that controls the spatial distribution of the late reverb. The direction of this vector controls the
    ...
    /**
     * Introduces a cyclic echo in the reverberation decay, which will be noticeable with transient or percussive
     * sounds. A larger value will make this effect more prominent.
     * <p>
    ...
    /**
     * Controls the amount of pitch change. Low values will contribute to reinforcing the perceived effect by reducing
    ...
    /**
     * When this flag is set, the high-frequency decay time automatically stays below a limit value that’s derived from
     * the setting of the property Air Absorption Gain HF. This limit applies regardless of the setting of the property
     * Decay HF Ratio, and the limit doesn’t affect the value of Decay HF Ratio. This limit, when on, maintains a
     * natural sounding reverberation decay by allowing you to increase the value of Decay Time without the risk of
     * getting an unnaturally long decay time at high frequencies. If this flag is set to AL_FALSE, high-frequency decay
